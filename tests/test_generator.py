...
class GeneratorTests(unittest.TestCase):
    def test_writes_both_validated_feed_files(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertEqual(counts, {"GAME Watch": 1, "GameWith": 1})
            self.assertIn(
    ...
    def test_keeps_both_existing_files_when_validation_fails(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            output = Path(directory)
